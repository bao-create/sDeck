    ...
    with open(file) as f:
        ...
        while line: #for each line
            ...
            if line.find("$") == -1: # is the line a comment
                ...
                if line.find("+") != -1: #check for the + denoting the declariation continues on the next line
                    cont_flag =True
                ...
                if item_type == 0: #depending on the item type, use the line to create an "item" object
                ...
                else: #if item_type isnt defined or == -1 for a comment
                    pass
